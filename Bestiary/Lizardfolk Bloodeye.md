...
- "name": "Reptilian Escape"
  "effect": "While the bloodeye still has a tail, whenever the bloodeye is grabbed,\
    \ slowed, weakened, or knocked prone, the bloodeye can lose their tail to immediately\
